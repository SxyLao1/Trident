...
<p>
  <img src="https://img.shields.io/badge/version-1.7.8-blue?style=flat-square" alt="Version">
...
- **Web 管理后台** — 暗色终端风格界面，SSE 实时日志流，HTMX 驱动
- **企业级安全** — CSRF 全站保护、IP 白名单、Scrypt 密码哈希
