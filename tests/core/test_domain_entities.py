...
import pytest
from core.domain.entities import FileRecord, DetectionSource, FileStatus, ScanResult, QuarantineRecord
from core.domain.registry_adapter import RegistryRepository, get_registry_repository
